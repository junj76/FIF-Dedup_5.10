...
sudo cp ./dm-dedup.ko /lib/modules/5.10.37/kernel/drivers/md
...
sudo echo "0 $TARGET_SIZE dedup $META_DEV $DATA_DEV 4096 md5 cowbtree 100 0" | dmsetup create FIF-Dedup
